...
import com.tplink.cloud.parking.commonservice.annoation.validate.TPNotBlankValidator;
...
@Documented
@Constraint(validatedBy = {TPNotBlankValidator.class})
public @interface TPNotBlank {
